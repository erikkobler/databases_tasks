//redo the RestartBlocking Class, but preventing all Livelocks:
...
public class NoLiveLocks_alt {
    ...
    public static void main(String[] args) {
        // Create DB
        NoLiveLocks_alt b = new NoLiveLocks_alt();
        b.createDB();

        // Create tasks and their queries
        ArrayList<NoLiveLocks_alt.Blocker> my_tasks = new ArrayList<>(num_tasks);
